...
class DeviceProfile {
    ...
    void updateFromConfiguration(Resources resources, int wPx, int hPx,
        ...
        //* add by bonovo zbiao
        //********************************************************
        if(allAppsNumRows > 2) allAppsNumRows = 2;
        if(allAppsNumCols > 5) allAppsNumCols = 5;
        //********************************************************
    }
    ...
    public void layout(Launcher launcher) {
        ...
        Rect padding = getWorkspacePadding(isLandscape
                ...
                : CellLayout.PORTRAIT);
        workspace.setPadding(padding.left, 5,
                padding.right, LauncherAppState.PendingSpace);
...
public class DynamicGrid {
    ...
    public DynamicGrid(Context context, Resources resources,
        ...
        if(LauncherAppState.ScreenLargeFlag){
			Log.v("aaa","bigbigbig");
		deviceProfiles.add(new DeviceProfile("CarPad-II-P",
                600, 1024,  2, 5,  72, 18, (hasAA ? 5 : 4), 62));
			//deviceProfiles.add(new DeviceProfile("CarPad-II-P",
                //480, 800,  2, 5,  50, 18, (hasAA ? 5 : 4), 50));
	 }else{
	 		Log.v("aaa","smallsmallsmall");
		deviceProfiles.add(new DeviceProfile("CarPad-II-P",
                480, 800,  2, 5,  50, 17, (hasAA ? 5 : 4), 50));
		//deviceProfiles.add(new DeviceProfile("CarPad-II-P",
              //  600, 1024,  2, 5,  72, 20, (hasAA ? 5 : 4), 62));
	 }
