...
public class Controller
    ...
    // file chooser
    @Override
    public void showFileChooser(ValueCallback<String[]> uploadMsg, String acceptType, boolean capture) {
        mUploadHandler = new UploadHandler(this);
        mUploadHandler.showFileChooser(uploadMsg, acceptType, capture);
    }
